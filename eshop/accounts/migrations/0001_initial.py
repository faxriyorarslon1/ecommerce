    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pic', models.ImageField(upload_to='accounts/users/', verbose_name='rasm')),
                ('middlename', models.CharField(max_length=20, verbose_name='sharifi')),
                ('phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, max_length=128, null=True, region=None, unique=True)),
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Active', 'Active'), ('Deactivated', 'Deactivated')], max_length=11)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('role', models.CharField(choices=[('Super Admin', 'Super Admin'), ('Admin', 'Admin'), ('Customer', 'Customer')], max_length=11)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=30, verbose_name='Shaxar nomi')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
